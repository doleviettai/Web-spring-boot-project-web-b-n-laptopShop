...
<head>
    ...
    <title>Delete ${product.id} - SB Admin</title>
                ...
                <div class="row">
                    <div class="col-12 mx-auto">
                        ...
                        <div class="alert alert-danger">
                            Bạn có chắc là muốn xóa sản phẩm với id là ${product.id} ?
                        </div>

                        <form:form method="post" action="/admin/product/delete" modelAttribute="newProduct">
                            <div class="mb-3" style="display: none;">
                                <label class="form-label">ID:</label>
                                <form:input type="text" class="form-control" path="id" value="${id}"></form:input>
                            </div>
