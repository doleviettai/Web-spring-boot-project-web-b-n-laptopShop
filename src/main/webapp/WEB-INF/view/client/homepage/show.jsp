<html lang="en" xmlns:jsp="http://www.w3.org/1999/XSL/Transform" xmlns:c="" xmlns:fmt="">
...
<!--                                                            <p class="text-dark fs-5 fw-bold mb-0">${product.price} đồng</p>-->
                                                            <p style="font-size:15px; text-align:center; width:100%;" class="text-dark fw-bold mb-3">
                                                                <fmt:formatNumber type="number" value="${product.price}"/> đồng
