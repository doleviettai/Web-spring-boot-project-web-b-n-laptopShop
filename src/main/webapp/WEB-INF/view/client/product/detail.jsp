<html lang="en" xmlns:jsp="http://www.w3.org/1999/XSL/Transform" xmlns:fmt="">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Sản Phẩm ${id}</title>
            ...
            <div class="col-lg-8 col-xl-9">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h5 class="fw-bold mb-3"><fmt:formatNumber type="number" value="${product.price}"/> đồng</h5>
